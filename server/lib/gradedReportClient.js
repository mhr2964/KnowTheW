// gradedReportClient.js — generates AI-graded player reports via the shared Anthropic client.
//
...
// `enabled` is re-exported from ./anthropic so the route's `gradedReportClient.enabled` check is
// unchanged; it reflects the shared client's live state.
