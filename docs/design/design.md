...
| [feature-backlog.md](./feature-backlog.md) | Unscheduled, undesigned feature ideas — pre-design holding area, not a design doc itself | Living |
| [bdl-expansion-roadmap.md](./bdl-expansion-roadmap.md) | 12-feature build plan from the 2026-08-21 BDL GOAT-tier endpoint audit — standings, site nav rework, clutch/scoring/usage/defense dashboards, team four factors, team shot chart, league shot-zone leaderboards, per-game advanced stats, injuries, odds | Shipped 2026-08-22 |
| [reference-site-features-roadmap.md](./reference-site-features-roadmap.md) | Basketball-reference-style features built from data already fetched — plus/minus, league leaders, awards history, injury/odds hubs, game box score + PBP viewer, notable games, all-time/franchise leaders, team H2H, misc/opponent advanced-stat bundles | In progress |
